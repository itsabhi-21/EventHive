      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-[#0a0a0a] px-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-[#888] text-xs">Enter your details to sign in to your account.</p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-[#666] text-[10px] uppercase">Or continue with email</span>
            <div className="flex-1 h-px bg-[#2a2a2a]"></div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-3.5 h-3.5 rounded border-[#2a2a2a] bg-[#1a1a1a] text-[#f59e0b] focus:ring-[#f59e0b] focus:ring-offset-0"
                />
                <span className="text-[#aaa] text-xs">Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-[#f59e0b] text-xs hover:text-[#d97706] transition">
                Forgot password?
              </Link>
            </div>
          ...
          {/* Sign Up Link */}
          <p className="text-center text-[#888] text-xs mt-5">
            Don't have an account?{' '}
            <Link to="/register" className="text-[#f59e0b] hover:text-[#d97706] transition font-medium">
              Sign up
            </Link>
          </p>
